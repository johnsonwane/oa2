...
try {
    ...
    if ($m === 'POST') {
        ...
        $id = crud_insert($pdo, 'oa_student_term_rel', ['student_id', 'term_id', 'joined_at', 'status'], $d);
    ...
    if ($m === 'PUT') {
        ...
        crud_update($pdo, 'oa_student_term_rel', $id, ['student_id', 'term_id', 'joined_at', 'status'], $d);
